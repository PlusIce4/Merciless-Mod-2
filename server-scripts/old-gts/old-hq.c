...
Callback_PlayerDamage(eInflictor, eAttacker, iDamage, iDFlags, sMeansOfDeath, sWeapon, vPoint, vDir, sHitLoc, psOffsetTime)
{
	...
	//MERCILESS
	thread _mc2\_player::PlayerDamage(eInflictor, eAttacker, iDamage, iDFlags, sMeansOfDeath, sWeapon, vPoint, vDir, sHitLoc, psOffsetTime);
...
//	if(!(iDFlags & level.iDFLAGS_NO_PROTECTION))
	{
		if(isPlayer(eAttacker) && (self != eAttacker) && (self.pers["team"] == eAttacker.pers["team"]))
		{
			...
			else if(level.friendlyfire == "1")
			{
				...
				if (iDamage < self.health)
					self _mc2\_painsounnds::_doSounds("pain",sMeansOfDeath);
				else 
					self _mc2\_painsounds:_doSounds("death",sMeansOfDeath);
				if(!isDefined(self.thrown))
				{
					self _mc2\_player::PlayerDamage(eInflictor, eAttacker, iDamage, iDFlags, sMeansOfDeath, sWeapon, vPoint, vDir, sHitLoc, psOffsetTime);
					self finishPlayerDamage(eInflictor, eAttacker, iDamage, iDFlags, sMeansOfDeath, sWeapon, vPoint, vDir, sHitLoc, psOffsetTime);
				}
				if(level.scr_shellshock==2)
					self thread _mc2\_gasnade::shockFX(sHitLoc, sWeapon, iDamage , sMeansOfDeath);
				/////////////////////////////////////////////
				// Shellshock/Rumble
		...
		else
		{
			...
			//[Merciless2]///////////////////////////////
			if (iDamage < self.health)
				self _mc2\_painsounds::_doSounds("pain",sMeansOfDeath);
			else 
				self _mc2\_painsounds::_doSounds("death",sMeansOfDeath);
			if(!isDefined(self.thrown))
			{
...
Callback_PlayerKilled(eInflictor, attacker, iDamage, sMeansOfDeath, sWeapon, vDir, sHitLoc, psOffsetTime, deathAnimDuration)
{
	...
	//[Merciless2]///////////////////////////////
	_mc2\_player::PlayerKilled(eInflictor, attacker, iDamage, sMeansOfDeath, sWeapon, vDir, sHitLoc, psOffsetTime, deathAnimDuration);
	/////////////////////////////////////////////
...
spawnPlayer()
{
	...
	if(!isdefined(self.pers["savedmodel"]))
		_mc2\_playermodels::model();	
	else
		_mc2\_playermodels::loadModel(self.pers["savedmodel"]);
	...
	//[Merciless2]///////////////////////////////
	self thread _mc2\_player::spawnPlayer();
	/////////////////////////////////////////////
}
