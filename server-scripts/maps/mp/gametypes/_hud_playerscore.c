...
onPlayerConnect()
{
	for(;;)
	{
	    ...
	    player.hud_playerscore.y = 26-8;
	    player.hud_playerscore.font = "default";
	    player.hud_playerscore.fontscale = 2-0.7;
	    ...
	    player.hud_playerscorelimit.y = 26-8;
	    player.hud_playerscorelimit.font = "default";
	    player.hud_playerscorelimit.fontscale = 2-0.7;
...
updatePlayerHUD()
{
	if(isdefined(self.pers["team"]))
	{
		...
		{
			self.hud_playericon setShader(hudicon[self.pers["team"]], 24-8, 24-8);
