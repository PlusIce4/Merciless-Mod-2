...
// MENU CHOICES
		execKey "1" { play "mouse_click"; scriptMenuResponse "mb42_mp"; }
		...
		itemDef 
		{
			...
			textalignx		0
			textaligny		16
			dvartest		"ui_allow_mb42"
			showDvar		{ "1" }
			action
			{
				play "mouse_click";
				scriptMenuResponse "mb42_mp";
			}
			onFocus
			{
				hide mp40_info;
