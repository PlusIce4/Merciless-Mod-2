...
#define ORIGIN_GRENADESLOT4			356 176

{
	menuDef
	{
		name			"weapon_american_engineer"
		rect			0 0 640 480
		...
		onEsc 
		{
			close weapon_american_engineer;
		}
		onOpen 
		{
			hide m1carbine_info;
