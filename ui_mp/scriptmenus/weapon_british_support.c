...
// MENU CHOICES
		...
		execKey "2" { play "mouse_click"; scriptMenuResponse "bren_mp"; }
		execKey "3" { play "mouse_click"; scriptMenuResponse "thompson_mp"; }
		execKey "4" { play "mouse_click"; scriptMenuResponse "sten_mp"; }
