...
//#define ORIGIN_WEAPONIMAGE2			296 64
...
// MENU CHOICES
		...
		itemDef 
		{
			...
			textalignx		0
			textaligny		16
			dvartest		"ui_allow_allied_soldier"
			showDvar		{ "1" }
			action
			{
				play "mouse_click";
		...
		itemDef 
		{
			...
			textalignx		0
			textaligny		16
			dvartest		"ui_allow_allied_medic"
			showDvar		{ "1" }
			action
			{
				play "mouse_click";
		...
		itemDef 
		{
			...
			textalignx		0
			textaligny		16
			dvartest		"ui_allow_allied_sniper"
			showDvar		{ "1" }
			action
			{
				play "mouse_click";
		...
		itemDef 
		{
			...
			forecolor		1 1 1 1
			type			ITEM_TYPE_BUTTON
			text			"@MC2_US_ENGINEER"
			textfont		UI_FONT_NORMAL
			textscale		.24
			textalignx		0
			textaligny		16
			dvartest		"ui_allow_allied_engineer"
			showDvar		{ "1" }
			action
			{
				play "mouse_click";
		...
		itemDef 
		{
			...
			textalignx		0
			textaligny		16
			dvartest		"ui_allow_allied_support"
			showDvar		{ "1" }
			action
			{
				play "mouse_click";
...
//CLASS COUNT INFO
		...
		itemDef
		{
			...
			textstyle		3
			type			ITEM_TYPE_EDITFIELD
			dvar			"ui_allied_support"
			forecolor		1 1 1 1
			autowrapped
			text			"Support Gunners: "
			textfont		UI_FONT_BOLD
			textscale		.18
			decoration
		}		
