...
// MENU CHOICES
		...
		execKey "1" { play "mouse_click"; scriptMenuResponse "mosin_nagant_sniper_mp" }
		execKey "2" { play "mouse_click"; scriptMenuResponse "scoped_svt_mp" }
...
//Scoped SVT	
		...
		itemDef 
		{
			name			"button_scoped_svt"
			visible			1
			rect			16 66 60 60
			origin			ORIGIN_MENUWINDOW
			forecolor		1 1 1 1
			type			ITEM_TYPE_BUTTON
			text			"@MC2_3_scopedsvt"
			textfont		UI_FONT_NORMAL
			textscale		.24
			textalignx		0
			textaligny		16
			dvartest		"ui_allow_scoped_svt"
			showDvar		{ "1" }
			action
			{
				play "mouse_click";
				scriptMenuResponse "scoped_svt_mp";
			}
			onFocus
			{
				hide nagantsniper_info;
				play "mouse_over";
				show scoped_svt_info;
				show weapon_propertiestext;
				show grenade_info;
			}
...
// WEAPON IMAGES
		...
		itemDef
		{
			name			"scoped_svt_info"
			visible 		0
			rect			0 0 224 112
			origin			ORIGIN_WEAPONIMAGE
	 		style			WINDOW_STYLE_SHADER
			background		"weapon_svt41"	
			decoration
		}	
