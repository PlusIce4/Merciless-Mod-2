...
// MENU CHOICES
		...
		execKey "2" { play "mouse_click"; scriptMenuResponse "pps42_mp" }
		execKey "3" { play "mouse_click"; scriptMenuResponse "ppsh41_mp" }
