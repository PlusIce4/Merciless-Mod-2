...
// MENU CHOICES
		...
		execKey "2" { play "mouse_click"; scriptMenuResponse "g43_sniper_mp"; }
		...
		itemDef 
		{
			name			"button_g43sniper"
			visible			1
			rect			16 66 60 60
			origin			ORIGIN_MENUWINDOW
			forecolor		1 1 1 1
			type			ITEM_TYPE_BUTTON
			text			"@MC2_2_SCOPED_G43"
			textfont		UI_FONT_NORMAL
			textscale		.24
			textalignx		0
			textaligny		16
			dvartest		"ui_allow_g43sniper"
			showDvar		{ "1" }
			action
			{
				play "mouse_click";
				scriptMenuResponse "g43_sniper_mp";
			}
			onFocus
			{
				hide g43_info;
