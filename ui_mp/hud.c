...
//	}
	...
	menuDef 
	{
    	...
    	fullScreen MENU_FALSE
    	visible MENU_TRUE
		rect 100 -75 40 40 HORIZONTAL_ALIGN_LEFT VERTICAL_ALIGN_BOTTOM
	...
	menuDef
	{
		name "Compass"
 	   	fullScreen MENU_FALSE
 	   	visible MENU_TRUE
 	   	rect -20 -145 COMPASS_SIZE COMPASS_SIZE HORIZONTAL_ALIGN_LEFT VERTICAL_ALIGN_BOTTOM
